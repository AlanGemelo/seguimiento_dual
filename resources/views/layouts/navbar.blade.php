            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @if ((Auth::user()->rol_id === 1 && session("direccion")) || Auth::user()->rol_id === 4)
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="empresasDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Empresas
                        </a>
                    ...
                    @if (Auth::user()->rol_id === 1 || Auth::user()->rol_id === 4)
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="direccionDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">

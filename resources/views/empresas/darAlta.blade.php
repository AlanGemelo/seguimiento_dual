        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <x-forms.section-header
                    title="Registro de Alta de la Unidad Económica"
                ...
                <div class="card-body">
                    <form
                        class="pt-3"
                        action="{{ route('empresas.registrar', $empresa->id) }}"
                        method="post"
                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="tamano_ue" class="form-label"
                                        >Tamaño de la UE p</label
                                    >
                                    <select
                                        name="tamano_ue"
                                        id="tamano_ue"
                            ...
                            <div class="p-3">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        size="8"
                                        id="direcciones_ids"
                                        name="direcciones_ids[]"
                                        multiple
                                        aria-label="Seleccionar Direcciones de Carrera"
                                        size="5"
                                    >
                        ...
                        <div class="mb-4 p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input
                                            ...
                                            name="inicio_conv"
                                            id="inicio_conv"
                                            value="{{ old('inicio_conv', $empresa->inicio_conv) }}"
                                            required
                                        />
                                    </div>
                                    @error ('inicio_conv')
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="anos_conv" class="form-label"
                                        >Años de convenio
                                        <span class="text-danger"
                                            >*</span
                                        ></label
                        ...
                        <div class="mb-4 p-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="convenioA"
                                        >Convenio Específico</label
                                    >
                                    <div
                                        class="d-flex justify-content-between align-items-center gap-2 mt-1"
                                    >
                                        <input
                                            type="file"
                                        ...
                                        @else
                                            <span
                                                class="text-muted"
                                                id="textNoConvenioA"
                                                >No hay documento cargado</span
                                            >
                                        @endif
                                        <button
                                            type="button"
                                            class="btn btn-secondary"
                                            id="btnCambiarConvenioA"
                                            onclick="
                                                mostrarInput(
                                                    'inputConvenioA',
                                                    'btnCambiarConvenioA',
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="convenioMA"
                                        >Convenio Marco-Empresa</label
                                    >
                                    <div
                                        class="d-flex justify-content-between align-items-center gap-2 mt-1"
                                    >
                                        ...
                                        <button
                                            type="button"
                                            class="btn btn-secondary"
                                            id="btnCambiarConvenioMA"
                                            onclick="
                                                mostrarInput(
                                                    'inputConvenioMA',
                                                    'btnCambiarConvenioMA',
                                                    'linkConvenioMA',
                                                    'textNoConvenioMA',
                                                )
                                            "
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    >
                                        ...
                                        @if ($empresa->ine)
                                            <a
                                                href="{{ url(Storage::url($empresa->ine)) }}"
                                                class="btn btn-primary flex-grow-1"
                                                target="_blank"
                                                id="linkIne"
                                            >

                            ...
                            <form class="pt-3"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="ine">INE <span class="text-danger">*</span></label> <input
                                                hidden type="file" class="form-control form-control-lg" id="ine"
    ...
    @enderror
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="formatoA">Formato A<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <input hidden  type="file" class="form-control form-control-lg" id="formatoA"
    ...
    @enderror
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="formatoB">Formato B<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <input hidden  type="file" class="form-control form-control-lg" id="formatoB"
    ...
    @enderror
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="formatoC">Formato C<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <input hidden  type="file" class="form-control form-control-lg" id="formatoC"

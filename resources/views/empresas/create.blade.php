            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <x-forms.section-header
                        title="Registro de Unidad Económica"
                        ...
                        >
                            ...
                            <div class="mb-4 p-3">
                                ...
                                <small class="text-muted text-stone-950">
                                    Seleccione las carreras con las que su
                                    empresa desea colaborar en el sistema de
                                    formación dual.
                                </small>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button
                                                type="button"
                                                class="btn text-dark w-auto px-4 h-1"
                                                style="
...
@section ('scripts')
    <script>
        function calcularFechaFinal() {
            ...
            const aniosASumar = parseInt(
                document.getElementById('anos_conv').value,
            );
            ...
            if (mes === 2 && dia === 29) {
                ...
                const esBisiesto =
                    nuevoAnio % 4 === 0 &&
                    (nuevoAnio % 100 !== 0 || nuevoAnio % 400 === 0);
                const nuevaFecha = esBisiesto
                    ? new Date(nuevoAnio, 1, 29)
                    : new Date(nuevoAnio, 1, 28);
        ...
        // Formateo telefonico
        // Obtener el input una sola vez
        const telInput = document.getElementById('telefono');

        // Formatear mientras el usuario escribe
        telInput.addEventListener('input', function (e) {
            let val = e.target.value.replace(/\D/g, '').slice(0, 10); // solo números
            if (val.length > 6)
        ...
        // Quitar guiones justo antes de enviar

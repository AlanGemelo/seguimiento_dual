                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form class="pt-3" action="{{ route('empresas.update', $empresa->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control  " name="razon_social"
                                                id="razon_social" value="{{ old('razon_social', $empresa->razon_social) }}">
                                            @error('razon_social')
                                                <div class="text-danger invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <!-- Representante Legal  -->
                                <div class="row mb-4">
                                    <h5 class="section-title fw-bold">Representante Legal <span
                                ...
                                <div class="row">
                                    <h5 class="section-title fw-bold">Vinculación Académica <span
                                            class="text-danger">*</span>
                                    </h5>
                                    <small class="text-muted text-stone-950">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" name="inicio_conv"
                                                    id="inicio_conv"
                                                    value="{{ old('inicio_conv', $empresa->inicio_conv) }}" required>
                                            </div>
                                            @error('inicio_conv')
                                        ...
                                        <div class="col-md-4 mb-3 ">
                                            <label for="anos_conv" class="form-label">Años de convenio <span
                                                    class="text-danger ">*</span></label>
                                            <div class="input-group">
                                                <input type="number" data-tipo="numbers" name="anos_conv"
                                                    id="anos_conv" class="form-control">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                <input type="date" class="form-control" name="fin_conv"
                                                    id="fin_conv" value="{{ old('fin_conv', $empresa->fin_conv) }}">
                                            </div>
                                            @error('fin_conv')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center gap-2 mt-1">
                                                ...
                                                @else
                                                    <span class="text-muted" id="textNoIne">No hay documento
                                                        cargado</span>
                                                @endif

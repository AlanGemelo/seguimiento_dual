@extends ('layouts.app')
@section('title', 'Crear Unidad Económica')
@section('styles')
                    ...
                    <div class="mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nombre" class="form-label">Nombre de la empresa
                                    <span
                                        ...
                                        title="Esta información es necesaria">
                                        *
                                    </span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Calle, colonia, código postal, ciudad, estado, país</small>
                                @error('direccion')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-3 mb-3 ext-tel">
                                <label for="ext_telefonica" class="form-label ext-tel">
                                    Ext.
                                    <small class="text-muted"></small>
                                </label>
                                <input
                                    type="text"
                                    class="form-control @error('ext_telefonica') is-invalid @enderror"
                                    id="ext_telefonica"
                                    name="ext_telefonica"
                                    placeholder="Ext."
                    ...
                    <div class="mb-4 p-3">
                        ...
                        <div class="card mb-4 shadow-sm border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    <h6 class="fw-bold">Subir convenio <span
                                            class="text-danger"
                                            data-bs-toggle="tooltip"
                                            data-bs-placement="top"
                                            title="Esta información es necesaria">

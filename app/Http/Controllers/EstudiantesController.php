...
//     5-Termino del PE
    ...
    public function index(): View
    {
        ...
        return view('estudiantes.index', compact('estudiantes', 'estudiantesDeleted','situation','becas'));
    }
    ...
    public function create(): View
    {
        ...
        return view('estudiantes.create', compact('empresas', 'academico', 'carreras','situation','tipoBeca','becas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('estudiantes.' . $vista, compact('estudiante', 'empresas', 'academicos', 'industrials', 'carreras', 'cuatrimestres','becas','tipoBeca'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $estudiantes->fill([
            ...
            'formatoA' => $perfil_ingles ?? $estudiantes->perfil_ingles,
            'formatoB' => $perfil_ingles ?? $estudiantes->perfil_ingles,
            'formatoC' => $perfil_ingles ?? $estudiantes->perfil_ingles,

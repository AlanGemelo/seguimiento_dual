    ...
    <div class="card">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary rounded pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Anexo 1.3 - Formato de Registro de Interesados de UE y Estudiantes ED</h6>
                <div class="float-end">
                    <a href="{{ route('anexo1_3.create') }}" class="btn btn-primary" title="Crear Nuevo">

                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-tipo="numbers"
                                                    class="form-control form-control-lg" id="matricula" name="matricula"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled class="form-select" aria-label="Seleccionar Cuatrimestre"
                                                    ...
                                                    @foreach ($cuatrimestres as $cuatrimestre)
                                                        ...
                                                        @else
                                                            <option value="{{ $cuatrimestre }}">{{ $cuatrimestre }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="nombre_proyecto">Nombre del Proyecto <span
                                                        class="text-danger">*</span></label>
                                                <input disabled type="text" class="form-control form-control-lg"
                                                    id="nombre_proyecto" placeholder="Nombre del Proyecto"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled class="form-select"
                                                    aria-label="Seleccionar Mentor Academico" name="academico_id">
                                            ...
                                            <div class="form-group">
                                                <label for="asesorin_id" class="form-label">Acesor Indutrial <span
                                                        class="text-danger">*</span></label>
                                                <select disabled class="form-select"
                                                    aria-label="Seleccionar Asesor Industrial" name="asesorin_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control form-control-lg"
                                                    name="inicio_dual" id="inicio_dual"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div
                                                    style="display: flex; justify-content: space-between;align-items: center; gap: 4px">
                                                    <input hidden type="file" class="form-control form-control-lg"
                                                        id="carta_acp" name="carta_acp" value="{{ old('carta_acp') }}">
                                                    @error('carta_acp')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                    <a id='carta_acp_'
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div
                                                    style=" display: flex; justify-content: space-between;align-items: center; gap: 4px">
                                                    <input hidden type="file" class="form-control form-control-lg"
                                                        id="perfil_ingles" placeholder="perfil_ingles"
                                                        name="perfil_ingles" value="{{ old('perfil_ingles') }}">
                                                    @error('perfil_ingles')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                    <a id='perfil_ingles_'

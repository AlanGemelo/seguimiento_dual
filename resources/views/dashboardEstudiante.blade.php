                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 mb-3">
                                ...
                                <div class="info-value">{{ $estudiante->matricula }}<span>@utvtol.edu.mx</span></div>
                            </div>
                            <div class="col-lg-6 col-md-12 mb-3">
                                <label class="info-label">CURP</label>
                                <div class="info-value">{{ $estudiante->curp }}</div>
                            </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            <div class="list-group">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        @if ($estudiante->formato54)
                                            <a href="{{ url(Storage::url($estudiante->formato54)) }}" target="_blank"
                            ...
                            <input hidden type="file" id="formato54" name="formato54" accept=".pdf,.doc,.docx">
...
@section('scripts')
    <script>
        function mostrarInput() {
            // Muestra input de archivo y botón guardar

            ...
            <form action="{{ route('anexo1_1.store') }}" method="POST" id="anexo1_1_form">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('institucion_educativa') is-invalid @enderror" id="institucion_educativa" name="institucion_educativa" required value="{{ old('institucion_educativa', 'Universidad Tecnológica del Valle de Toluca') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('programa_educativo_id') is-invalid @enderror" id="programa_educativo_id" name="programa_educativo_id" required>
                            @foreach($carreras as $carrera)
                                <option value="{{ $carrera->id }}" {{ old('programa_educativo_id') == $carrera->id ? 'selected' : '' }}>{{ $carrera->nombre }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('fecha_elaboracion') is-invalid @enderror" id="fecha_elaboracion" name="fecha_elaboracion" required value="{{ old('fecha_elaboracion') }}">
                ...
                <div class="mb-3">
                    ...
                    <table class="table table-bordered" id="competencias_table">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control @error('competencias.0.competencia') is-invalid @enderror" name="competencias[0][competencia]" required></td>
                                <td><input type="text" class="form-control @error('competencias.0.actividad') is-invalid @enderror" name="competencias[0][actividad]" required></td>
                                <td><input type="text" class="form-control @error('competencias.0.asignatura') is-invalid @enderror" name="competencias[0][asignatura]" required></td>
                                <td><input type="number" class="form-control @error('competencias.0.cuatrimestre') is-invalid @enderror" name="competencias[0][cuatrimestre]" min="1" max="11" required></td>
...
<div id="helpModal" class="modal">
    <div class="modal-content">
        ...
        <ol>
            <li><strong>Referencia 1:</strong> Registrar el nombre de la Institución Educativa donde se imparte el programa de estudios.</li>
            <li><strong>Referencia 2:</strong> Registrar el nombre del Programa Educativo o carrera que se está analizando.</li>
            <li><strong>Referencia 3:</strong> Describir las competencias específicas que se enuncian en el programa de estudio de las asignaturas propuestas para ED.</li>
            <li><strong>Referencia 4:</strong> Describir de manera clara y precisa las actividades de aprendizaje que deben realizarse para el logro de las competencias específicas.</li>
            <li><strong>Referencia 5:</strong> Colocar nombre y clave de las asignaturas.</li>
            <li><strong>Referencia 6:</strong> Indicar el periodo del plan de estudio en el que se desarrollan las competencias referidas.</li>
        </ol>
    </div>
</div>

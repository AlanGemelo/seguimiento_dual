    ...
    <div class="container">
        <div class="card">
            <div class="card-header-adjusted">
                <h3 class="card-title">Anexo 1.3 - Formato de Registro de Interesados de UE y Estudiantes ED</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('anexo1_3.store') }}" method="POST" id="anexo1_3_form">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('lugar') is-invalid @enderror" id="lugar"
                                name="lugar" required value="{{ old('lugar') }}">
                            @error('lugar')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" class="form-check-input" id="participacion_anterior"
                                name="participacion_anterior" value="1"
                                {{ old('participacion_anterior') ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mb-3" id="motivo_no_participacion_row" style="display: none;">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('motivo_no_participacion') is-invalid @enderror" id="motivo_no_participacion"
                                name="motivo_no_participacion">{{ old('motivo_no_participacion') }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" class="form-check-input" id="interes_participar"
                                name="interes_participar" value="1"
                                {{ old('interes_participar') ? 'checked' : '' }}>
                        </div>
                    ...
                    <div class="row mb-3" id="motivo_no_interes_row" style="display: none;">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('motivo_no_interes') is-invalid @enderror" id="motivo_no_interes"
                                name="motivo_no_interes">{{ old('motivo_no_interes') }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" class="form-check-input" id="informacion_clara"
                                name="informacion_clara" value="1" required
                                {{ old('informacion_clara') ? 'checked' : '' }}>
                        </div>
                        <div class="col-md-6">
                            <label for="comentarios_adicionales" class="form-label">Comentarios Adicionales</label>
                            <textarea class="form-control @error('comentarios_adicionales') is-invalid @enderror" id="comentarios_adicionales"
                                name="comentarios_adicionales">{{ old('comentarios_adicionales') }}</textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('participacion_anterior').addEventListener('change', function() {
                document.getElementById('motivo_no_participacion_row').style.display = this.checked ?
                    'none' : 'block';
            });

            document.getElementById('interes_participar').addEventListener('change', function() {
                document.getElementById('numero_estudiantes_row').style.display = this.checked ? 'block' :
                    'none';
                document.getElementById('motivo_no_interes_row').style.display = this.checked ? 'none' :
                    'block';
            });

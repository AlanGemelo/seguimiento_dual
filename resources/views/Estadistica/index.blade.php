                            ...
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" id="exportStatusExcel" class="btn btn-success text-white">Exportar a Excel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" id="exportBecaExcel" class="btn btn-success text-white">Exportar a Excel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" id="exportMentorExcel" class="btn btn-success text-white">Exportar a Excel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" id="exportEmpresaExcel" class="btn btn-success text-white">Exportar a Excel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" id="exportCarreraExcel" class="btn btn-success text-white">Exportar a Excel</a>
                                    </div>
                                </div>
                            </div>
                        </div>

        ...
        <div class="col-lg-12">
            <div class="card shadow">
                ...
                <x-forms.section-header
                    title="Datos del Candidato a la Modalidad Dual"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="direccion" class="form-label"
                                    >Dirección de carrera</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                                    value="{{ $estudiante->direccion->name ?? 'N/A' }}"
                                    disabled
                                />
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="status" class="form-label"
                                    >Situación en modalidad dual</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                                    value="{{ $estudiante->status == 1 ? 'Renovación' : 'Primera vez' }}"
                                    disabled
                                />
                            </div>
                        </div>

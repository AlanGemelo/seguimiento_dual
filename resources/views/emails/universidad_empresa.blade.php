...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Le informamos que el convenio actual con la empresa <span class="highlight">{{ $empresa->nombre }}</span>
                está próximo a vencer el día <span class="highlight">{{ $fechaVencimiento }}</span>.</p>
            <p>Para asegurar la continuidad de nuestra colaboración, le solicitamos gestionar la renovación del convenio
                a la mayor brevedad posible.</p>
            <p>Puedes revisar los detalles del convenio actual y proceder con la renovación accediendo al siguiente
                enlace:</p>

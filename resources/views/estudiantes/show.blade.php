                            ...
                            <div class="mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="name"
                                                placeholder="Nombre(s)" name="name" value="{{ $estudiante->name }}"
                                                disabled>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="inicio"
                                            name="inicio" value="{{ $estudiante->inicio }} " disabled>
                                    </div>
                                ...
                                @php
                                    ...
                                    $tipoBecaTexto =
                                        $estudiante->beca == 0
                                            ? $tipoBecaArray[$estudiante->tipoBeca ?? 0] ??
                                                'Tipo de beca no especificado'

                        ...
                        <tbody id="anexoTable">
                            @foreach ($anexos as $anexo)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('anexo1_2.edit', $anexo->id) }}" class="btn btn-warning"
                                        ...
                                        <a href="{{ route('anexo1_2.generatePdf', $anexo->id) }}" class="btn btn-info"
                                            style=" background-color: #F40F02">PDF</a>
                                        <a href="{{ route('anexo1_2.generateWord', $anexo->id) }}" class="btn btn-info"

                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="email" class="form-label">Correo electrónico institucional
                                </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="cuatrimestre" class="form-label">Cuatrimestre
                                </label>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="section-subtitle fw-bold">
                                ...
                                <div class="col-12">
                                    <h6 class="section-subtitle mt-1 fw-bold">
                                        Documentos de Formación Dual
                                    </h6>
                                    <div class="dropdown-divider mb-3"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="formato55">Evaluación de
                                                    Formación</label>
                                                <div class="mt-1">

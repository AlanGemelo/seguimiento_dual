                                ...
                                <div class="modal-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="/descargar/anexo 5.4 .pdf" class="btn btn-danger"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Descargar en PDF">
                                                <i class="mdi mdi-file-pdf"></i>
                                            </a>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            Anexo 5.5
                                            <a href="/descargar/Anexo 5.5 Seguimiento y Evaluación.docx"
                                                class="btn btn-info">
                                                <i class="mdi mdi-file-word"></i>
                                            </a>
                                            <a href="/descargar/anexo 5.5.pdf" class="btn btn-danger"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Descargar en PDF">
                                                <i class="mdi mdi-file-pdf"></i>
                                            </a>
                                        </li>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <input type="text" id="search" class="form-control" name="search"
                                        value="{{ $search }}" placeholder="Buscar estudiantes...">
                                </div>
                            </div>
                                        ...
                                        @else
                                            @foreach ($estudiantes as $estudiante)
                                                <tr class="animate__animated animate__fadeInDown " id='aiuda'>
                                                    ...
                                                    <td>{{ ($estudiantes->currentPage() - 1) * $estudiantes->perPage() + $loop->iteration }}
                                                    </td>
                                            ...
                                            @foreach ($candidatos as $estudiante)
                                                <tr class="animate__animated animate__fadeInDown " id='aiuda'>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('estudiantes.edit', Vinkla\Hashids\Facades\Hashids::encode($estudiante->matricula)) }}"
                                                            class="btn btn-twitter" style=" background-color: #ffa719">
                                                            <i class="mdi mdi-arrow-up btn-icon-prepend"
                                                                style="font-size: 1.5em;"></i>
                                                        </a>
                                                        @if (Auth::user()->rol_id === 1 || Auth::user()->rol_id === 4)
                                                            <button class="btn btn-danger"
    ...
    @section('scripts')
        <script>
            ...
            function deleteEstudiante(matricula, motivo) {
                ...
                form.action = `${window.BASE_URL}/estudiantes/${matricula}/delete`;
                $.ajax({
            ...
            function restoreRegistro(id) {
                ...
                form.action = `${window.BASE_URL}/estudiantes/${id}/restaurar`;
                $.ajax({
                    url: `${window.BASE_URL}/estudiantes/${id}/json`,
                    type: 'GET',
                    success: function(response) {
                        $('#bannerRestore').text('¿Estás seguro de restaurar este registro? ' +
                            response[0].name + ' ' +
                            response[0].apellidoM + ' ' +
                            response[0].apellidoP +
                            ', Con la matricula: ' +
            ...
            function destroyMentor(id) {
                ...
                form.action = `${window.BASE_URL}/estudiantes/${id}/force`;
                $.ajax({
                    url: `${window.BASE_URL}/estudiantes/${id}/json`,
                    type: 'GET',
                    success: function(response) {
                        $('#bannerDelete').text('¿Estás seguro de restaurar este registro? ' +
                            response[0].name + ' ' +
                            response[0].apellidoM + ' ' +
                            response[0].apellidoP +
                            ', Con la matricula: ' +

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="inicio" class="form-label">Fecha de Ingreso <span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control form-control-lg" name="inicio" id="inicio"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="fin" class="form-label">Fecha de Egreso <span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control form-control-lg" name="fin" id="fin"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3" id="tipoBeca" style="display: none">
                                    <label for="tipoBeca" class="form-label">Apoyo Economico <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select" aria-label="Seleccionar el tipo de beca" name="tipoBeca"
                                        id="selectTipoBeca">
                                        <option value="" disabled

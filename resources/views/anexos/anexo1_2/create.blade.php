            ...
            <form action="{{ route('anexo1_2.store') }}" method="POST" id="anexo1_2_form">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="fecha_elaboracion" name="fecha_elaboracion" value="{{ date('Y-m-d') }}" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nombre_firma_ie" name="nombre_firma_ie" required>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <table class="table table-bordered" id="actividades_table">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control" name="actividades[0][actividad]" required></td>
                                <td><input type="text" class="form-control" name="actividades[0][responsable]" required></td>
                                <td><input type="text" class="form-control" name="actividades[0][unidad_medida]" required></td>
                                <td><input type="text" class="form-control" name="actividades[0][meta]" required></td>
                                <td>
                                    <button type="button" class="btn btn-secondary" data-bs-toggle="collapse" data-bs-target="#periodo_0">Seleccionar Meses</button>
                                    <div id="periodo_0" class="collapse mt-2">
                                        @foreach(['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'] as $mes)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="actividades[0][periodo][]" value="{{ $mes }}">
                                                <label class="form-check-label">{{ $mes }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </td>
                                <td><input type="number" class="form-control" name="actividades[0][presupuesto]" required></td>
...
<div id="helpModal" class="modal">
    <div class="modal-content">
        ...
        <ol>
            <li><strong>Referencia 1:</strong> Describir la actividad a realizar, relacionada con la difusión de la Educación Dual.</li>
            <li><strong>Referencia 2:</strong> Registrar al responsable de la actividad a realizar.</li>
            <li><strong>Referencia 3:</strong> Indicar la Unidad de Medida con la que se verificará el cumplimiento de lo programado.</li>

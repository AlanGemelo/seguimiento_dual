                ...
                <div class="card-body">
                    <form class="pt-3" action="{{ route('empresas.registrar', $empresa->id) }}" method="post"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="tamano_ue" id="tamano_ue" class="form-control" required>
                                        <option value="" disabled>
                                            Seleccione el tamaño de la unidad
                                            económica
                                        </option>
                                            ...
                                            <option value="{{ $direccion->id }}"
                                                @if (
                                                    (is_array(old('direcciones_ids')) && in_array($direccion->id, old('direcciones_ids'))) ||
                                                        (!old() && optional(session('direccion'))->id == $direccion->id)) selected @endif>
                                                {{ $direccion->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center gap-2 mt-1">
                                            <input type="file" class="form-control d-none" id="inputEspecifico"
                                                name="archivo_especifico" accept="application/pdf" />
                                            ...
                                            <button type="button" class="btn btn-secondary" id="btnCambiarEspecifico"
                            ...
                            <div class="card mb-4 shadow-sm border-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center gap-2 mt-1">
                                            <input type="file" class="form-control d-none" id="inputMarco"
                                                name="archivo_marco" accept="application/pdf" />

                                            @if ($convenioMarco?->archivo)
                                                <a href="{{ asset('storage/' . $convenioMarco->archivo) }}"
                                                    target="_blank" class="btn btn-primary flex-grow-1" id="linkMarco">
                                                    Ver documento
                                                    <span class="mdi mdi-file-pdf-box"></span>
                                                </a>
                                            @else
                                            ...
                                            <button type="button" class="btn btn-danger d-none" id="btnCancelarMarco"
                        ...
                        <div class="row">
                            ...
                            <div class="dropdown-divider mb-4"></div>
                            <div class="col-md-6 mb-1">
                                <label for="ine" class="form-label">INE
                                    <span class="text-danger">*</span></label>
                                <div class="d-flex justify-content-between align-items-center gap-2 mt-1">
...
@section('scripts')
    <script>
        ...
        function mostrarInput(inputId, btnId, linkId, textId) {
            ...
            const cancelarBtn = document.getElementById(
                'btnCancelar' + inputId.replace('input', ''),
            );
    ...
    <script>
        function inicializarVigencia(checkboxId, anosId, finId) {
            const checkbox = document.getElementById(checkboxId);
            const anos = document.querySelector(`[name="${anosId}"]`).parentElement;
            const fin = document.querySelector(`[name="${finId}"]`).parentElement;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            inicializarVigencia('indefinido_especifico', 'anos_especifico', 'fin_especifico');
            inicializarVigencia('indefinido_marco', 'anos_marco', 'fin_marco');

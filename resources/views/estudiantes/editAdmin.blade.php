                    ...
                    <form class="pt-3"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="email" class="form-label blo">Correo electrónico institucional
                                        <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="name" class="form-label">Nombre(s)
                                        <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="apellidoP" class="form-label">Apellido Paterno
                                        <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="apellidoM" class="form-label">Apellido Materno
                                        <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="fecha_na" class="form-label">Fecha de Nacimiento
                                        <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="direccion_id" class="form-label">Dirección de carrera
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="carrera_id" class="form-label">Programa Educativo
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="inicio" class="form-label">Fecha de Ingreso
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="fin" class="form-label">Fecha de Egreso
                                </label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="status" class="form-label">Situación Dual
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nombre_proyecto" class="form-label">Nombre del Proyecto
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="academico_id" class="form-label">Mentor Academico
                                </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="empresa_id" class="form-label">Empresa aplicable a Dual
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="asesorin_id" class="form-label">Asesor Industrial
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="inicio_dual" class="form-label">Inicio Dual
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="fin_dual" class="form-label">Fin Dual
                                </label>
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="beca" class="form-label">Beca Dual
                                            <span class="text-danger">*</span></label>
                                        <select class="form-select" aria-label="Seleccionar beca..." id="beca"
                                    ...
                                    <div class="col-md-6 mb-3" id="tipoBeca" style="display: none">
                                        <label for="tipoBeca" class="form-label">Apoyo Economico
                                            <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div
                                        ...
                                        <a id="ine_" href="{{ url(Storage::url($estudiante->ine)) }}"
                                            class="form-control form-control-lg btn-primary" target="_blank">Ver INE
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div
                                        ...
                                        <a id="historial_academico_"
                                            ...
                                            class="form-control form-control-lg btn-primary" target="_blank">Ver HIstorial
                                            Academico
                                            <span class="mdi mdi-file-pdf-box"></span>
                                        </a>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div
                                        ...
                                        <a id="perfil_ingles_" href="{{ url(Storage::url($estudiante->perfil_ingles)) }}"
                                            class="form-control form-control-lg btn-primary" target="_blank">Ver Perfil de
                                            Ingles
                                            <span class="mdi mdi-file-pdf-box"></span>
                                        </a>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formato54" class="mb-1">Formato 5.4
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formato55" class="mb-1">Formato 5.5
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="minutas" class="mb-1">Minutas
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="plan_form" class="mb-1">Plan de Formacion
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="evaluacion_form" class="mb-1">Evaluación de Formación</label>
                                            <div
                                                style="
                                                    display: flex;
                                                    justify-content: space-between;
                                ...
                                <div class="col-12 mt-3" id="formatosBeca" style="display: none">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="formatoA" class="mb-1">Formato A
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formatoB" class="mb-1">Formato B
                                            </label>
                                            <div
                                                style="
                                                    display: flex;
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="formatoC" class="mb-1">Formato C
                                            </label>
                                            <div
                                                style="
                                                    display: flex;

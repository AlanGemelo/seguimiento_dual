                ...
                <form action="{{ route('anexo2_1.update', $anexo2_1->id) }}" method="POST" id="anexo2_1_form">
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="unidad_economica" name="unidad_economica"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="seccion_1[legalmente_constituida]" value="1"
                                            {{ old('seccion_1.legalmente_constituida', $anexo2_1->seccion_1['legalmente_constituida']) == '1' ? 'checked' : '' }}
                                            required>
                                    </td>
                                    <td>
                                        <input type="radio" name="seccion_1[legalmente_constituida]" value="0"

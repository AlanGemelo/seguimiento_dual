        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow">
                    <x-section-header title="Datos de la Dirección de Carrera"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="director"
                                        name="director"
                        ...
                        <div class="d-flex justify-content-between">
                            <x-back-button url="{{ route('direcciones.index') }}" />

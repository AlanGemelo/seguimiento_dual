                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data"" action="{{ route('empresas.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="telefono" name="telefono"
                                            maxlength="13" placeholder="Ingrese el numero de contacto"
                            ...
                            <div class="mb-4 p-3">
                                <h5 class="section-title fw-bold">Direcciones de Carrera <span class="text-danger">*</span>
                                </h5>
                            ...
                            <div class="mb-4 p-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" accept="application/pdf, image/jpeg, image/png"
                                                class="form-control" id="convenioA" name="convenioA" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" accept="application/pdf, image/jpeg, image/png"
                                                class="form-control" id="convenioMA" name="convenioMA" required>
                                            <button class="btn btn-outline-secondary" type="button"
                                                data-bs-toggle="tooltip" title="Formato PDF, máximo 5MB">
                                                <i class="fas fa-info-circle"></i>
                                            </button>
    ...
    @section('scripts')
        <script>
            ...
            telInput.addEventListener('input', function(e) {
                ...
                if (val.length > 6) e.target.value = val.replace(/(\d{3})(\d{3})(\d{0,4})/, '$1-$2-$3');
                else if (val.length > 3) e.target.value = val.replace(/(\d{3})(\d{0,3})/, '$1-$2');

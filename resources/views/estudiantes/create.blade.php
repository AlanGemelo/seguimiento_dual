                            ...
                            <form class="pt-3" action="{{ route('estudiantes.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="datepicker-popup" class="input-group date datepicker navbar-date-picker">
                                        ...
                                        <input type="text" class="form-control" name="inicio_dual" id="inicio_dual"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="datepicker-popup" class="c">
                                        <span class="input-group-addon input-group-prepend border-right">
                                            <span class="icon-calendar input-group-text calendar-icon"></span>
                                        </span>
                                        <input type="text" class="form-control" name="fin_dual" id="fin_dual"
                                            value="{{ old('fin_dual') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" aria-label="Seleccionar Empresa" name="asesorin_id">
                                        ...
                                        @foreach ($industrial as $mentorIndustrial)
                                            <option value="{{ $mentorIndustrial->id }}">{{ $mentorIndustrial->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('asesorin_id')

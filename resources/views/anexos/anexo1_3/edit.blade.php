            ...
            <form action="{{ route('anexo1_3.update', $anexo1_3->id) }}" method="POST" id="anexo1_3_form">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="fecha_realizacion" name="fecha_realizacion" value="{{ \Carbon\Carbon::parse($anexo1_3->fecha_realizacion)->format('Y-m-d') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="lugar" class="form-label">Lugar</label>
                        <input type="text" class="form-control" id="lugar" name="lugar" value="{{ $anexo1_3->lugar }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="razon_social" class="form-label">Razón Social</label>
                        <input type="text" class="form-control" id="razon_social" name="razon_social" value="{{ $anexo1_3->razon_social }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="rfc" class="form-label">RFC</label>
                        <input type="text" class="form-control" id="rfc" name="rfc" value="{{ $anexo1_3->rfc }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="domicilio" class="form-label">Domicilio</label>
                        <input type="text" class="form-control" id="domicilio" name="domicilio" value="{{ $anexo1_3->domicilio }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="nombre_representante" class="form-label">Nombre del Representante</label>
                        <input type="text" class="form-control" id="nombre_representante" name="nombre_representante" value="{{ $anexo1_3->nombre_representante }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="cargo_representante" class="form-label">Cargo del Representante</label>
                        <input type="text" class="form-control" id="cargo_representante" name="cargo_representante" value="{{ $anexo1_3->cargo_representante }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="telefono" class="form-label">Teléfono</label>
                        <input type="text" class="form-control" id="telefono" name="telefono" value="{{ $anexo1_3->telefono }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="correo_electronico" class="form-label">Correo Electrónico</label>
                        <input type="email" class="form-control" id="correo_electronico" name="correo_electronico" value="{{ $anexo1_3->correo_electronico }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="actividad_economica" class="form-label">Actividad Económica</label>
                        <input type="text" class="form-control" id="actividad_economica" name="actividad_economica" value="{{ $anexo1_3->actividad_economica }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="numero_empleados" class="form-label">Número de Empleados</label>
                        <input type="number" class="form-control" id="numero_empleados" name="numero_empleados" value="{{ $anexo1_3->numero_empleados }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="participacion_anterior" class="form-label">¿Ha participado anteriormente en Educación Dual?</label>
                        <select class="form-control" id="participacion_anterior" name="participacion_anterior" required>
                            <option value="1" {{ $anexo1_3->participacion_anterior ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ !$anexo1_3->participacion_anterior ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="interes_participar" class="form-label">¿Tiene interés en participar en Educación Dual?</label>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="numero_estudiantes" class="form-label">Número de estudiantes que podría recibir</label>
                        <input type="number" class="form-control" id="numero_estudiantes" name="numero_estudiantes" value="{{ $anexo1_3->numero_estudiantes }}">
                    </div>
                </div>
                @else
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="informacion_clara" class="form-label">¿La información proporcionada fue clara?</label>
...
<div id="helpModal" class="modal">
    <div class="modal-content">
        ...
        <ol>
            ...
            <li><strong>Referencia 16:</strong> Registrar el teléfono de contacto del representante de la unidad económica.</li>
            <li><strong>Referencia 17:</strong> Indicar el correo electrónico del representante de la unidad económica.</li>
        </ol>
    </div>
</div>

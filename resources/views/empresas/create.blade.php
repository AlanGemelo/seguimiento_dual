                    ...
                    <div class="mb-4 p-3">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Mantén presionada la tecla <span class="text-black"><strong>Ctrl (Windows)</strong></span> o
                                <span class="text-black"><strong>Command (Mac)</strong></span> para seleccionar múltiples
                                opciones
                            </small>

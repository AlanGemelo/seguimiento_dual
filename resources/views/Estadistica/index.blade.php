                        ...
                        <div class="card-body">
                            <form id="filtroEstudiantesForm">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fechaFiltro" class="form-label text-dark">Filtrar por
                                                Fechas</label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="month" id="fechaInicio" name="fechaInicio"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="month" id="fechaFin" name="fechaFin"
                                                class="form-control border border-dark rounded">
                                        </div>
                                    </div>
                                </div>

    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <!-- Encabezado -->
                <x-forms.section-header title="Datos del Candidato a la Modalidad Dual"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $estudiante->matricula }}" disabled />
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="direccion" class="form-label">Programa Educativo</label>
                                <input type="text" class="form-control"
                                    value="{{ $estudiante->carrera->nombre ?? 'N/A' }}" disabled />
                            </div>
                            <div class="col-md-6 mb-3">

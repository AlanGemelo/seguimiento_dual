    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <x-forms.section-header title="Anexo 2.1 - Evaluación de la UE" description="" />
                                ...
                                <table class="table ms-3 mt-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_1[legalmente_constituida]"
                                                    value="1"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_1[convenio_cooperacion]" value="1"
                                                    {{ old('seccion_1.convenio_cooperacion') == 'Sí' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_1[convenio_cooperacion]" value="0"
                                                    {{ old('seccion_1.convenio_cooperacion') == 'No' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_1[convenio_aprendizaje]" value="1"
                                                    {{ old('seccion_1.convenio_aprendizaje') == 'Sí' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_1[convenio_aprendizaje]" value="0"
                                                    {{ old('seccion_1.convenio_aprendizaje') == 'No' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_1[convenio_marco]" value="1"
                                                    {{ old('seccion_1.convenio_marco') == 'Sí' ? 'checked' : '' }}
                                                    required></td>
                                            <td><input type="radio" name="seccion_1[convenio_marco]" value="0"
                                                    {{ old('seccion_1.convenio_marco') == 'No' ? 'checked' : '' }}
                                                    required></td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[personal_capacitado]" value="1"
                                                    {{ old('seccion_2.personal_capacitado') == '1' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[personal_capacitado]" value="2"
                                                    {{ old('seccion_2.personal_capacitado') == '2' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[personal_capacitado]" value="3"
                                                    {{ old('seccion_2.personal_capacitado') == '3' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[areas_especializadas]"
                                                    value="1"
                                                    {{ old('seccion_2.areas_especializadas') == '1' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[areas_especializadas]"
                                                    value="2"
                                                    {{ old('seccion_2.areas_especializadas') == '2' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[areas_especializadas]"
                                                    value="3"
                                                    {{ old('seccion_2.areas_especializadas') == '3' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[mentor_licenciatura]"
                                                    value="1"
                                                    {{ old('seccion_2.mentor_licenciatura') == '1' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[mentor_licenciatura]"
                                                    value="2"
                                                    {{ old('seccion_2.mentor_licenciatura') == '2' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[mentor_licenciatura]"
                                                    value="3"
                                                    {{ old('seccion_2.mentor_licenciatura') == '3' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[plan_formacion]" value="1"
                                                    {{ old('seccion_2.plan_formacion') == '1' ? 'checked' : '' }} required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[plan_formacion]" value="2"
                                                    {{ old('seccion_2.plan_formacion') == '2' ? 'checked' : '' }} required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[plan_formacion]" value="3"
                                                    {{ old('seccion_2.plan_formacion') == '3' ? 'checked' : '' }} required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[capacidad_plan]" value="1"
                                                    {{ old('seccion_2.capacidad_plan') == '1' ? 'checked' : '' }} required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[capacidad_plan]" value="2"
                                                    {{ old('seccion_2.capacidad_plan') == '2' ? 'checked' : '' }} required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[capacidad_plan]" value="3"
                                                    {{ old('seccion_2.capacidad_plan') == '3' ? 'checked' : '' }} required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_2[puestos_aprendizaje]"
                                                    value="1"
                                                    {{ old('seccion_2.puestos_aprendizaje') == '1' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[puestos_aprendizaje]"
                                                    value="2"
                                                    {{ old('seccion_2.puestos_aprendizaje') == '2' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_2[puestos_aprendizaje]"
                                                    value="3"
                                                    {{ old('seccion_2.puestos_aprendizaje') == '3' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="radio" name="seccion_3[actividades_seguras]"
                                                    value="1"
                                                    {{ old('seccion_3.actividades_seguras') == '1' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_3[actividades_seguras]"
                                                    value="2"
                                                    {{ old('seccion_3.actividades_seguras') == '2' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                            <td><input type="radio" name="seccion_3[actividades_seguras]"
                                                    value="3"
                                                    {{ old('seccion_3.actividades_seguras') == '3' ? 'checked' : '' }}
                                                    required>
                                            </td>
                                        </tr>
                                    </tbody>

                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="email" class="form-control" value="{{ $mentor->email ?? 'N/A' }}" disabled>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $mentor->apellidoP }}" disabled>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="apellidoM" class="form-label">Apellido Materno</label>
                                    <input type="text" class="form-control" value="{{ $mentor->apellidoM }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $mentor->direccion->name ?? 'N/A' }}"
                                    disabled>
                            </div>
                        </div>
                    </div>

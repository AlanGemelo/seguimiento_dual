        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow">
                    <!-- Encabezado -->
                    <x-section-header title="Datos del Mentor Académcio"
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="card h-100">
                                            <div class="card-body d-flex flex-column">
                                                <h5 class="card-title">{{ $estudiante->name }} {{ $estudiante->apellidoP }}
                                                </h5>
                                                <p class="card-text">
                                                    <strong>Matrícula:</strong> {{ $estudiante->matricula }}<br>
                                                    <strong>Carrera:</strong>
                                                    {{ $estudiante->carrera->nombre ?? 'N/A' }}<br>
                                                    <strong>Empresa:</strong> {{ $estudiante->empresa->nombre ?? 'N/A' }}
                                                </p>
                                                <div class="mt-auto">

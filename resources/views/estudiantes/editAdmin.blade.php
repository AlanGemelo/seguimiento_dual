        ...
        <div class="col-lg-12">
            <div class="card shadow">
                ...
                <x-forms.section-header
                    title="Actualización de Estudiante Dual"
                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="email" class="form-label blo"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="fecha_na" class="form-label"
                                        >Fecha de Nacimiento
                                        <span class="text-danger"
                                            >*</span
                                        ></label
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select
                                    class="form-select"
                                    aria-label="Seleccionar Dirección de carrera"
                                    name="direccion_id"
                                >
                                    <option
                                        value=""
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select
                                    class="form-select"
                                    aria-label="Seleccionar Programa Educativo"
                                    name="carrera_id"
                                    id="carrera_id"
                                >
                                    <option
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="cuatrimestre" class="form-label"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select
                                    class="form-select"
                                    aria-label="Seleccionar Situación Dual"
                                    name="status"
                                >
                                    <option
                                        value=""
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="academico_id" class="form-label"
                                    >Mentor Academico
                                </label>
                                <select
                                    class="form-select"
                                    aria-label="Seleccionar Mentor Académico"
                                    name="academico_id"
                                    id="academico_id"
                                >
                                    <option
                        ...
                        <div class="row">
                            <h5 class="section-title fw-bold mt-4">
                                Datos de la unidad económica
                            </h5>
                            <div class="droCdown-divider mb-4"></div>

                            <div class="col-md-6 mb-3">
                                <label for="empresa_id" class="form-label"
                                    >Empresa aplicable a Dual
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="asesorin_id" class="form-label"
                                    >Asesor Industrial
                                </label>
                                <select
                                    class="form-select"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="inicio_dual" class="form-label"
                                    >Inicio Dual
                                </label>
                                <input
                                    type="date"
                                    ...
                                    name="inicio_dual"
                                    id="inicio_dual"
                                    value="{{ old('inicio_dual', $estudiante->inicio_dual) }}"
                                />
                                @error ('inicio_dual')
                                    <div class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="fin_dual" class="form-label"
                                    >Fin Dual
                                </label>
                                <input
                                    type="date"
                                    ...
                                    name="fin_dual"
                                    id="fin_dual"
                                    value="{{ old('fin_dual', $estudiante->fin_dual) }}"
                                />
                                @error ('fin_dual')
                                    <div class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="beca" class="form-label"
                                            >Beca Dual
                                            <span class="text-danger"
                                                >*</span
                                            ></label
                                    ...
                                    >
                                        ...
                                        <select
                                            class="form-select"
                                            aria-label="Seleccionar el tipo de beca"
                                            name="tipoBeca"
                                            id="selectTipoBeca"
                                        >
                                            <option
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    >
                                        ...
                                        <a
                                            id="ine_"
                                            href="{{ url(Storage::url($estudiante->ine)) }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    <label
                                        for="historial_academico"
                                        class="mb-1"
                                        >Historial Academico</label
                                    >
                                    <div
                                        style="
                                            display: flex;
                                    ...
                                    >
                                        <input
                                            ...
                                            placeholder="historial_academico"
                                        ...
                                        <button
                                            class="btn btn-secondary w-50"
                                            id="historial_academicoC"
                                            onclick="
                                                ocultar(
                                                    'historial_academico_',
                                                    'historial_academico',
                                                    'historial_academicoC',
                                                )
                                            "
                                            type="button"
                                        >
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="perfil_ingles" class="mb-1"
                                        >Perfil de Ingles</label
                                    >
                                    <div
                                        style="
                                            display: flex;
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="formato51" class="mb-1"
                                                >Formato 5.1</label
                                            >
                                            <div
                                                style="
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formato54" class="mb-1"
                                                >Formato 5.4
                                            </label>
                                            <div
                                                style="
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formato55" class="mb-1"
                                                >Formato 5.5
                                            </label>
                                            <div
                                                style="
                                ...
                                <div class="col-12 mt-2">
                                    <h6 class="section-subtitle mt-3">
                                        Documentos de Proceso Dual
                                    </h6>
                                    <div class="dropdown-divider mb-3"></div>

                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="carta_acp" class="mb-1"
                                                >Carta de Aceptación</label
                                            >
                                            <div
                                                style="
                                                    display: flex;
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            >
                                                ...
                                                <a
                                                    id="minutas_"
                                                    href="{{ url(Storage::url($estudiante->minutas)) }}"
                                                    class="form-control form-control-lg btn-primary"
                                                    target="_blank"
                                                    >Ver Minutas
                                                    <span
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="plan_form" class="mb-1"
                                                >Plan de Formacion
                                            </label>
                                            <div
                                                style="
                                            ...
                                            >
                                                ...
                                                <a
                                                    id="plan_form_"
                                                    href="{{ url(Storage::url($estudiante->plan_form)) }}"
                                                    class="form-control form-control-lg btn-primary"
                                                    target="_blank"
                                                    >Ver Plan de Formacion
                                                    <span
                                                        class="mdi mdi-file-pdf-box"
                                                    ></span>
                                                </a>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    class="form-control form-control-lg"
                                                    id="evaluacion_form"
                                                    placeholder="evaluacion_form"
                                                    name="evaluacion_form"
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button
                                    class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn mr-4"
                                    type="submit"
...
@section ('scripts')
    ...
    <script>
        ...
        function ocultar(id, id2, text) {
            ...
            document.getElementById(`${text}`).textContent = elemento.hidden
                ? 'Ver Documento'
            ...
            $('#direccion_id').change(function () {
                ...
                if (direccionId) {
                    ...
                    $('#carrera_id option').each(function () {
                        if (
                            $(this).data('direccion') == direccionId ||
                            $(this).val() == ''
                        ) {
                            $(this).show();
                        } else {
